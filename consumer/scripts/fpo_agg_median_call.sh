...
NEAR_ENV=$network near call $fpoAccountId aggregate_median_call "{\"pairs\": $pairs, \"providers\": $providers, \"min_last_update\":\"$min_last_update\", \"receiver_id\": \"$receiverId\"}" --accountId $accountId --gas=300000000000000
