...
//     SIMULATION_EXAMPLE_BYTES => "../res/simulation_example.wasm",
// }
...
//         .transfer(ntoy(50))
//         .deploy_contract(FPO_BYTES.to_vec())
