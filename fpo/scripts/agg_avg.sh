...
NEAR_ENV=$network near call $fpoAccountId aggregate_avg "{\"pairs\": $pairs, \"providers\": $providers, \"min_last_update\":$min_last_update}" --accountId $accountId --gas=300000000000000
